...
namespace _15pl04.Ucc.CommunicationServer.Collections
{
    public class LexicographicQueue<TKey, TVal>
    {
        ...
        public LexicographicQueue(int capacity)
        {
            _dictionary = new Dictionary<TKey, Queue<TVal>>(capacity);
        }
        ...
        public IEnumerator<TVal> GetEnumerator(TKey key)
        {
            return _dictionary[key].GetEnumerator();
        }
